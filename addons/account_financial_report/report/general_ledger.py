...
class GeneralLedgerReport(models.AbstractModel):
    ...
    def _get_initial_balance_data(
        ...
        for gl in gl_initial_acc:
            ...
            if gen_ld_data[acc_id]["init_bal"]["balance"] < 0:
                gen_ld_data[acc_id]["init_bal"]["balance"] = 0
            # gen_ld_data[acc_id]["init_bal"]["balance"] = gl["balance"]
            gen_ld_data[acc_id]["fin_bal"] = {}
            gen_ld_data[acc_id]["fin_bal"]["credit"] = max(gl["credit"], 0)
            gen_ld_data[acc_id]["fin_bal"]["debit"] = max(gl["debit"], 0)
            gen_ld_data[acc_id]["fin_bal"]["balance"] = max(gl["balance"], 0)
            gen_ld_data[acc_id]["init_bal"]["bal_curr"] = gl["amount_currency"]
            gen_ld_data[acc_id]["fin_bal"]["bal_curr"] = max(gl["amount_currency"], 0)
        ...
        if gl_initial_acc_prt:
            for gl in gl_initial_acc_prt:
                ...
                if gen_ld_data[acc_id][prt_id]["init_bal"]["balance"] < 0:
                    gen_ld_data[acc_id][prt_id]["init_bal"]["balance"] = 0
                # gen_ld_data[acc_id][prt_id]["init_bal"]["balance"] = gl["balance"]
                gen_ld_data[acc_id][prt_id]["fin_bal"] = {}
                gen_ld_data[acc_id][prt_id]["fin_bal"]["credit"] = max(gl["credit"], 0)
                gen_ld_data[acc_id][prt_id]["fin_bal"]["debit"] = max(gl["debit"], 0)
                gen_ld_data[acc_id][prt_id]["fin_bal"]["balance"] = max(gl["balance"], 0)
                gen_ld_data[acc_id][prt_id]["init_bal"]["bal_curr"] = gl[
                    "amount_currency"
                ]
                gen_ld_data[acc_id][prt_id]["fin_bal"]["bal_curr"] = max(gl["amount_currency"], 0)
        ...
        if unaffected_id:
            ...
            #     "balance"
            # ]
            if gen_ld_data[unaffected_id]["init_bal"]["balance"] < 0:
                gen_ld_data[unaffected_id]["init_bal"]["balance"] = 0
    ...
    def _get_move_line_data(self, move_line):
        move_line_data = {
            ...
            "debit": max(move_line["debit"], 0),
            "credit": max(move_line["credit"], 0),
            "balance": max(move_line["balance"], 0),
            "bal_curr": max(move_line["amount_currency"], 0),
        ...
        if move_line_data["balance"] < 0:
            move_line_data["balance"] = 0
        if (
        ...
        for move_line in move_lines:
            ...
            if acc_id in acc_prt_account_ids:
                ...
                if prt_id not in gen_ld_data[acc_id]:
                    ...
                    gen_ld_data[acc_id][prt_id]["fin_bal"]["credit"] = max(gen_ld_data[acc_id][prt_id]["fin_bal"]["credit"] + move_line["credit"], 0)
                    gen_ld_data[acc_id][prt_id]["fin_bal"]["debit"] = max(gen_ld_data[acc_id][prt_id]["fin_bal"]["debit"] + move_line["debit"], 0)
                    gen_ld_data[acc_id][prt_id]["fin_bal"]["balance"] = max(gen_ld_data[acc_id][prt_id]["fin_bal"]["balance"] + move_line["balance"], 0)
                if foreign_currency:
                    gen_ld_data[acc_id][prt_id]["fin_bal"]["bal_curr"] = max(gen_ld_data[acc_id][prt_id]["fin_bal"]["bal_curr"] + move_line["amount_currency"], 0)
            else:
