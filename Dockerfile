...
RUN pip3 -qq install --prefix=/usr/local --no-cache-dir --upgrade --requirement https://raw.githubusercontent.com/AstraTechRD/l10n_do_rnc_search/15.0/requirements.txt
